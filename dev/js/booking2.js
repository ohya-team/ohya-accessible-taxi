...
let vm = new Vue({
    ...
    mounted() {
        ...
        for(let i=0; i<this.deskCurweekDays.length; i++){
            ...
            this.tableTh.push({'deskWeek':this.deskCurweekDays[j],'MobileWeek':this.MobileCurweekDays[j],'month':this.leftMonth+1,'day':this.leftDay+i});
        }
    },
    computed: {
        btnStatus(){
